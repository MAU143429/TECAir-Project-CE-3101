namespace TECAir_API.Models.WEB
{
    public class VueloCompleto
    {
        ...
        public VueloCompleto(int no_vuelo, int no_reservacion, string origen, string ciudad_origen, string destino, string ciudad_destino, string modelo_av, string prt_abordaje, string v_dia, string v_mes, string v_ano, string h_llegada, int cant_escalas)
        {
